        ...
        <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
            <div className="mt-8 flex max-w-max items-center space-x-2 rounded-full bg-gray-100 p-1">
              ...
              <p className="text-sm font-medium">Join our Class &rarr;</p>
            </div>
          ...
          <div className="relative lg:col-span-5 lg:-mr-8 xl:col-span-6">
            <img
              ...
              src="http://sittechno.org/flashphotos/photos/a82abf2114cd06cc931b6457367bdee1.jpg"
              alt=""
            />
          </div>
        </div>
      ...
      <div className="mx-auto my-32 max-w-7xl px-2 lg:px-8">
        <div className="grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
          <div>
            ...
            This is for secure Payments that are easy and fast , no need of any complication in the process. 
            </p>
          </div>
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600">
              High value  on speed, our platform ensures your product.
            </p>
          </div>
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600">
              light and dark theam  for you to choose from.
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600">
              Filter Blocks is for  those who want more control over their website, so they can customize can  add or remove any block that they wish.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="cursor-pointer rounded-md border border-gray-400 shadow-lg transition-all duration-200">
              ...
              <div className="px-4 pb-5 sm:px-6 sm:pb-6">
                <p className="text-gray-500">
                  Add your mail any my our exclusive course  to access the full library of tutorials and guides. 
                  To start using the filter blocks,
                </p>
              </div>
            </div>
      ...
      <div className="mx-auto my-12 max-w-7xl md:my-24 lg:my-32">
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-6">
          <div className="px-4 py-10 lg:col-span-5 lg:px-0">
            ...
            Whether U just starting out or already have some experience, we offer various E-Learning courses designed to fit your needs. Curated from top educational institutions and industry leaders, our selection of E-Learning courses aims to provide quality training for everyone—from individual learners seeking personal growth to corporate teams looking to upskill. For those pursuing professional advancement, skill acquisition, or even a new career path, these E-Learning courses can be a valuable resource. Take the next step in your professional journey and enroll in a E-Learning course today!
            </p>
