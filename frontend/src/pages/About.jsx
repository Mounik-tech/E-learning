...
const locations = [
  {
    title: 'Siliguri Institute of Technology(SIT)',
    timings: 'Mon-Sat 9am to 5pm.',
    address: 'Siliguri Sukna , near Salbari',
  },
  {
    title: 'Maulana Abul Kalam Azad University of Technologi',
    timings: 'Mon-Sat 9am to 5.30pm.',
    address: 'kokata, Salt lake',
  },
]
...
const users = [
  {
    name: 'Surajit Dutta',
    image:  Images.Surajit,
    position: 'C Language Expert',
  },
   {
    name: 'Ratnankur Majumdar',
    image:  Images.RMSir,
    position: 'C Language Expert',
  },
  {
    name: 'Debarati Mitra',
    image:  Images.Debarathi,
    position: 'C Language Expert',
  },
  {
    name: 'Nilanjan Sir',
    image:  Images.Nilanjan,
    position: 'C Language Expert',
  },
  {
    name: 'Antara mam',
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
          <div className="max-w-max rounded-full border bg-gray-50 p-1 px-3">
            <p className="text-xs font-semibold leading-normal md:text-sm">About the Platform</p>
          </div>
          <p className="text-3xl font-bold text-gray-900 md:text-5xl md:leading-10">
          West Bengal’s Biggest & Most Trusted Educational Platform
          </p>
          <p className="max-w-4xl text-base text-gray-600 md:text-xl">
          Siliguri institute of technology (SIT)
            Hill Cart Road, Salbari, Sukna, West Bengal 734009
        ...
        <div className="mt-16 flex items-center">
          <div className="space-y-6 md:w-3/4">
            ...
            <p className="text-3xl font-bold text-gray-900 md:text-4xl">Meet our Teachers</p>
            <p className="max-w-4xl text-base text-gray-700 md:text-xl">
            We have the best and most experienced teachers to provide better knowledge to students.
            </p>-
            <div></div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-x-4 gap-y-4 py-16 md:flex-row">
          <div className="space-y-6">
            <p className="text-sm font-semibold md:text-base">Join our Classes &rarr;</p>
            <p className="text-3xl font-bold md:text-4xl">We&apos;re just getting started</p>
            <p className="text-base text-gray-600 md:text-lg">
            Unlock your potential by signing up SIT E-learning Platform-The most affordable learning Platform
            </p>
            <button
              type="button"
      ...
      <div className="mx-auto max-w-7xl">
        <footer className="px-4 py-10">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
            ...
            <div className="mb-8 lg:mb-0">
              <p className="mb-6 text-lg font-semibold text-gray-700">Courses</p>
              <ul className="flex flex-col space-y-4 text-[14px] font-medium text-gray-500">
                <li>UI / UX Design</li>
